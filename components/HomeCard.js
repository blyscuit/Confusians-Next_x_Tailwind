...
const HomeCard = (props) => {
  ...
  return (
    <div
      className={"relative group flex flex-col h-64 " + props.backgroundColor}
    >
      <div
        className={
          "absolute w-full group flex flex-col items-center h-64 justify-center  "
        }
      >
        ...
        >
          <p
            className={
              "text-3xl w-48 rounded-lg text-center py-2 transition duration-500 ease-out transform " +
              (props.image.length > 0 ? " group-hover:opacity-0 " : " ") +
              props.textColor +
              " " +
              ""
            }
