        ...
        },
        {
          ...
          value: function open() {
            ...
            if (this.caption !== "") {
              ...
              this.$photoCaption = $(
                '<div className="materialbox-caption"></div>',
              );
      ...
      [
        ...
        },
        {
          ...
          value: function _setupSwipeableTabs() {
            ...
            var $tabsWrapper = $(
              '<div className="tabs-content carousel carousel-slider"></div>',
            );
...
(function ($) {
      ...
      [
        ...
        },
        {
          ...
          value: function renderDay(opts) {
            ...
            return (
              ...
              ariaSelected +
              '">' +
              ('<button className="datepicker-day-button" type="button" data-year="' +
                opts.year +
                '" data-month="' +
                opts.month +
                '" data-day="' +
        ...
        },
        {
          ...
          value: function renderTable(opts, data, randId) {
            return (
              '<div className="datepicker-table-wrapper"><table cellpadding="0" cellspacing="0" className="datepicker-table" role="grid" aria-labelledby="' +
              randId +
              '">' +
          ...
          value: function renderTitle(
            ...
            var i = void 0,
              ...
              html =
                '<div id="' +
                randId +
                '" className="datepicker-controls" role="heading" aria-live="assertive">',
              monthHtml = void 0,
              yearHtml = void 0,
              prev = true,
              next = true;
            ...
            monthHtml =
              '<select className="datepicker-select orig-select-month" tabindex="-1">' +
              arr.join("") +
              "</select>";
            ...
            yearHtml =
              '<select className="datepicker-select orig-select-year" tabindex="-1">' +
              arr.join("") +
              "</select>";
  ...
  Datepicker._template = [
    '<div className= "modal datepicker-modal">',
    '<div className="modal-content datepicker-container">',
    '<div className="datepicker-date-display">',
    ...
    '<button className="btn-flat datepicker-clear waves-effect" style="visibility: hidden;" type="button"></button>',
    '<div className="confirmation-btns">',
    '<button className="btn-flat datepicker-cancel waves-effect" type="button"></button>',
    '<button className="btn-flat datepicker-done waves-effect" type="button"></button>',
    "</div>",
    "</div>",
    "</div>",
    "</div>",
...
(function ($) {
      ...
      [
        ...
        },
        {
          ...
          value: function _pickerSetup() {
            var $clearBtn = $(
              '<button className="btn-flat timepicker-clear waves-effect" style="visibility: hidden;" type="button" tabindex="' +
            ...
            $(
              '<button className="btn-flat timepicker-close waves-effect" type="button" tabindex="' +
                (this.options.twelveHour ? "3" : "1") +
                '">' +
  ...
  Timepicker._template = [
    ...
    '<div className="timepicker-display-column">',
    '<span className="timepicker-span-hours text-primary"></span>',
    ":",
    '<span className="timepicker-span-minutes"></span>',
    "</div>",
    '<div className="timepicker-display-column timepicker-display-am-pm">',
    '<div className="timepicker-span-am-pm"></div>',
    "</div>",
    "</div>",
    "</div>",
    '<div className="timepicker-analog-display">',
    '<div className="timepicker-plate">',
    '<div className="timepicker-canvas"></div>',
    '<div className="timepicker-dial timepicker-hours"></div>',
    '<div className="timepicker-dial timepicker-minutes timepicker-dial-out"></div>',
    "</div>",
    '<div className="timepicker-footer"></div>',
    "</div>",
    "</div>",
    "</div>",
  ].join("");
      ...
      [
        ...
        },
        {
          ...
          value: function _setupDropdown() {
            ...
            // Add caret
            var dropdownIcon = $(
              '<svg className="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>',
            );
